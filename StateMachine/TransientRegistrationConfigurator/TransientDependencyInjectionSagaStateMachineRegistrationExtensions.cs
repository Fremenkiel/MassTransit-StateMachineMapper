...
public static class TransientDependencyInjectionSagaStateMachineRegistrationExtensions
{
    public static ISagaRegistration RegisterSagaStateMachine<T, TSaga>(this IServiceCollection collection)
            ...
            where TSaga : class, SagaStateMachineInstance
        {
            ...
            {
                collection.AddTransient<TStateMachine>();
                collection.AddTransient<SagaStateMachine<TSaga>>(provider => provider.GetRequiredService<TStateMachine>());
