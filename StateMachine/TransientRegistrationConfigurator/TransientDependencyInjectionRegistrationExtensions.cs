using System;
using System.Linq;
using StateMachineMapper.StateMachine.TransientRegistrationConfigurator.Interfaces;
using MassTransit;
...
using MassTransit.UsageTracking;
...
public static class TransientDependencyInjectionRegistrationExtensions
{
        /// <summary>
        ...
        public static IServiceCollection AddTransientMassTransit(this IServiceCollection collection, Action<ITransientBusRegistrationConfigurator> configure = null)
        {
            ...
            var configurator = new TransientServiceCollectionBusConfigurator(collection);
