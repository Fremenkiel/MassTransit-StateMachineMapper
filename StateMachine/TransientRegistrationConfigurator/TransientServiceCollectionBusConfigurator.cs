...
public class TransientServiceCollectionBusConfigurator :
    TransientRegistrationConfigurator,
    ITransientBusRegistrationConfigurator
{
        public TransientServiceCollectionBusConfigurator(IServiceCollection collection)
        ...
        protected TransientServiceCollectionBusConfigurator(IServiceCollection collection, IContainerRegistrar registrar)
